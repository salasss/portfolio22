...
const fr: UIStrings = {
  ...
  'nav.contact': 'Contact',
  'cta.cv': 'CV',
  'hero.status': "Ouvert à l'alternance · Sept. 2026",
  'hero.scroll': 'défiler',
  'about.kicker': 'À propos',
  'about.title': 'Construire, automatiser et sécuriser la production à grande échelle.',
  'about.p1':
    "Étudiant en Master 1 Calcul Haute Performance et futur Mastère Spécialisé Expert en cybersécurité (Efrei), je combine une solide ingénierie logicielle avec une expertise Cloud & DevOps fortement orientée DevSecOps.",
  'about.p2':
    "Actuellement stagiaire chez Mobilize Financial Services (Renault Group), je travaille l'automatisation d'infrastructure (IaC), la conteneurisation et la sécurisation des pipelines CI/CD. Passionné de FinOps et de protection des environnements Cloud (GCP).",
  'glance.location.k': 'Localisation',
  'glance.location.v': 'Île-de-France, FR',
  'glance.availability.k': 'Disponibilité',
  'glance.availability.v': 'Alternance · Sept. 2026',
...
const en: UIStrings = {
  ...
  'nav.contact': 'Contact',
  'cta.cv': 'Resume',
  'hero.status': 'Open to work-study · Sept. 2026',
  'hero.scroll': 'scroll',
  'about.kicker': 'About',
  'about.title': 'Build, automate and secure production at scale.',
  'about.p1':
    'MSc student in High Performance Computing and incoming Specialized Master in Cybersecurity (Efrei), I blend solid software engineering with strong Cloud & DevOps expertise, DevSecOps-oriented.',
  'about.p2':
    'Currently an intern at Mobilize Financial Services (Renault Group), I work on infrastructure automation (IaC), containerization and securing CI/CD pipelines. Passionate about FinOps and protecting Cloud environments (GCP).',
  'glance.location.k': 'Location',
  'glance.location.v': 'Paris area, FR',
  'glance.availability.k': 'Availability',
  'glance.availability.v': 'Work-study · Sept. 2026',
